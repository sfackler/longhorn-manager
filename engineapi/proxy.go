...
func NewEngineClientProxy(im *longhorn.InstanceManager, logger logrus.FieldLogger, proxyConnCounter util.Counter) (c EngineClientProxy, err error) {
	...
	if err != nil {
		...
		if err != nil {
			return nil, errors.Wrap(err, "failed to initialize Instance Manager Proxy Client")
		}

		if err = client.CheckConnection(); err != nil {
			return nil, errors.Wrap(err, "failed to check Instance Manager Proxy Client connection")
		}
	}
